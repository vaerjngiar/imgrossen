...
class HomeView(View):
    def get(self, request):
        ...
        if form.is_valid():
            ...
            if name_query:
                s = Search(index="imgossen").query("match", name=name_query)
            else:
                s = Search(index="imgrossen")
            ...
            for bucket in result.aggregations.categories.buckets:
                ...
                category_url = "{}?{}".format(reverse("main"), category_url_params.urlencode())
        ...
        if "category" in request.GET:
            ...
            remove_category_url = "{}?{}".format(reverse("main"), remove_category_search_params.urlencode())
